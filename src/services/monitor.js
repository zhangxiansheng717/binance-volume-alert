    ...
    async checkMarket() {
        ...
        try {
            ...
            for (const item of currentData) {
                ...
                if (previous) {
                    const volumeChange = parseFloat((currentVolume / previous.volume).toFixed(2));
                    const priceChange = parseFloat(((currentPrice - previous.price) / previous.price * 100).toFixed(2));
